...
def inference(conversation, model, tokenizer, data_processor, use_subplot, logits_processor=None, use_placeholder=False, topk=5):
    """
    conversation = [
        {
            "role": "system",
    ...
    used_template = chat_template_subplot if use_subplot else chat_template
