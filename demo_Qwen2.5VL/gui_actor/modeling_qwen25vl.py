...
class Qwen2_5_VLForConditionalGenerationWithPointer(Qwen2_5_VLForConditionalGeneration):
    ...
    def forward(self,
        ...
        # print("*************************************")
        # print(f"output_attentions:{output_attentions}, output_hidden_states: {output_hidden_states}, return_dict: {return_dict}")
        # print(f"self.config.output_attentions: {self.config.output_attentions}, self.config.output_hidden_states: {self.config.output_hidden_states}, self.config.use_return_dict: {self.config.use_return_dict}")
        # print("*************************************")
